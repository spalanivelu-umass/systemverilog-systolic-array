...
REM
REM Generated by Vivado on Tue May 26 22:41:28 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_systolic_2x2_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_systolic_2x2_vlog.prj -log xvlog.log
